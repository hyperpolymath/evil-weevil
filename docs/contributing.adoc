...
Developers working *on* `Evil Weevil`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:metadatastician/Evil Weevil.git
cd Evil Weevil
...
* Bugs in `Evil Weevil`: file at `metadatastician/Evil Weevil/issues`.
