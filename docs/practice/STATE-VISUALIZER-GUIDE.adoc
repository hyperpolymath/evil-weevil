...
Use the template at TOPOLOGY.md in evil-weevil as a structural reference,
...
[source,bash]
----
cp /path/to/evil-weevil/TOPOLOGY.md ./TOPOLOGY.md
...
- ***_chora.deed (repo deed)** — AI agent entry point: allocation policy and directory invariants
