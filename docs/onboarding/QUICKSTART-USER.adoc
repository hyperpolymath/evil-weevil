...
// Replace evil-weevil, Rsr Template Repo — See README.adoc for details., just run, Rsr Template Repo started successfully. with actuals
= evil-weevil — Quick Start for Users
:toc:
:toclevels: 2
...
[source,bash]
----
just install --portable --prefix=./evil-weevil-portable
----
