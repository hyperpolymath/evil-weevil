...
# Evil Weevil container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping evil-weevil..."
...
# Examples:
#   exec /app/evil-weevil
#   exec /app/release/bin/evil-weevil start
#   exec /app/evil-weevil serve --host "${APP_HOST}" --port "${APP_PORT}"
