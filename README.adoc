...
A universally injectable enemy-intelligence kernel for computer games: host-agnostic and deterministic, with an Idris2-verified ABI over a Zig zero-overhead FFI seam, supporting enemy creation across engines.
...
* *AI gatekeeper protocol* — `evil-weevil_chora.deed` (the repo deed) is the
