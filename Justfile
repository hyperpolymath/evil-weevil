...
build *args:
    @echo "Building evil_weevil (debug)..."
...
build-release *args:
    @echo "Building evil_weevil (release)..."
...
cookbook:
    ...
    echo "= evil_weevil Justfile Cookbook" > "$OUTPUT"
...
man:
    #!/usr/bin/env bash
    mkdir -p docs/man
    cat > docs/man/evil_weevil.1 << EOF
    .TH evil_weevil 1 "$(date +%Y-%m-%d)" "{{version}}" "evil_weevil Manual"
    .SH NAME
    evil_weevil \- RSR-compliant project
    .SH SYNOPSIS
    .B just
    [recipe] [args...]
    .SH DESCRIPTION
    ...
    EOF
    echo "Generated: docs/man/evil_weevil.1"
...
doctor:
    @echo "Running diagnostics for evil-weevil..."
...
help-me:
    @echo "=== evil-weevil Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/metadatastician/evil-weevil/issues/new"
    @echo ""
